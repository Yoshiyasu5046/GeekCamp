...
public class User extends Human {
    private int userBit; //ユーザーの入札額
    public void setUserBit(int userBit) {this.userBit = userBit;} 
...
//            return userBit += userBit * 2;
//        }else {
//            return userBit -= userBit * 2;
//        }
//    }
//    public void insuarance() {
//        ArrayList first_picked_card = deal();
//        if ((int) first_picked_card.get(1) == 1) {
//            // User can use insuarance
//        }
//    }
...
//    }
//    public void split() {
//        ArrayList first_two_picks = deal();
//        if(first_two_picks.get(0) == first_two_picks.get(1)) {
//            // if a user choose split, they can use Hit method.
//            hit();
//        }
//    }
}
