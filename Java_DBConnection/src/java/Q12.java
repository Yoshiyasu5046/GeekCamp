...
public class Q12 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String inputName = request.getParameter("inputName"); //入力された名前
        String inputAge = request.getParameter("inputAge"); //入力された年齢
        String inputBD = request.getParameter("inputBirth"); //入力された生年月日
        ...
        try {
            ...
            db_st.setString(1, inputName);
            db_st.setInt(2, Integer.parseInt(inputAge));
            db_st.setDate(3, new java.sql.Date(sdf.parse(inputBD).getTime()));
